<template>
	<view class="page">
		<view class="mask" v-if="showLoading" style="background-color:#000000;margin-top:0!important;"
		...
		<swiper class="video-list" :vertical="true" :current="playerId" :circular="false" :duration="duration" @change="onchange"
			:style="'height:'+phone.windowHeight+'px'">
					...
					<view class="svod-bottom">
						<view class="svod-bottom-item">
							<text class="watch-free"
								v-if="!item.isBuy && item.gold>0 && !userInfo.isVip">免费观看次数：{{userInfo.free}} /
								{{userInfo.freeTot}}</text>
							<text
