	...
	<view class="bg" :style="{ height: bgHeight + 'px' }">
		...
		<view class="content">
			...
			<view class="content-gt" @click="skipUrl('/pages/member/deposit', 2)">
				<view>
					<image src="/static/mymoney/icon_8.png" mode="aspectFill"></image>
				</view>
				<view class="content-gt-title">余额提现</view>
				<image class="right-img" src="@/static/imgs/r.png"></image>
			</view>
			<view class="line"></view>
			<view class="content-gt" @click="skipUrl('/pages/member/transfer?type=corn', 2)">
				<view>
					<image src="/static/mymoney/icon_6.png" mode="aspectFill"></image>
				</view>
				<view class="content-gt-title">金币转余额</view>
				<image class="right-img" src="@/static/imgs/r.png"></image>
			</view>
			<view class="line"></view>
			<view class="content-gt" @click="skipUrl('/pages/member/transfer?type=money', 2)">
				<view>
					<image src="/static/mymoney/icon_7.png" mode="aspectFill"></image>
				</view>
				<view class="content-gt-title">余额转金币</view>
				<image class="right-img" src="@/static/imgs/r.png"></image>
			</view>
			<view class="line"></view>
			...
			<view class="content-gt" @click="skipUrl('/pages/member/bank_list', 2)">
				<view>
					<image src="/static/mymoney/icon_4.png" mode="aspectFill"></image>
				</view>
				<view class="content-gt-title">银行卡</view>
				<image class="right-img" src="@/static/imgs/r.png"></image>
			</view>
			<view class="line"></view>
			<view class="content-gt" @click="skipUrl('/pages/member/digit_list', 2)">
				<view>
					<image src="/static/mymoney/icon_4.png" mode="aspectFill"></image>
				</view>
				<view class="content-gt-title">数字钱包</view>
				<image class="right-img" src="@/static/imgs/r.png"></image>
			</view>
			<view class="line"></view>
			<view class="content-gt" @click="skipUrl('/pages/live/player_log', 2)" v-if="userInfo.isAnchor">
				<view>
					<image src="/static/mymoney/icon_5.png" mode="aspectFill"></image>
				</view>
