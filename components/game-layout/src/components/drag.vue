<template>
  ...
  @mouseup="mouseUp"
  >
  <svg t="1648984578816" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6571" data-spm-anchor-id="a313x.7781069.0.i7" width="36" height="36"><path d="M898.6 512m-58.8 0a58.8 58.8 0 1 0 117.6 0 58.8 58.8 0 1 0-117.6 0Z" p-id="6572" data-spm-anchor-id="a313x.7781069.0.i2" class="selected" fill="#ffffff"></path><path d="M640.9 512m-58.8 0a58.8 58.8 0 1 0 117.6 0 58.8 58.8 0 1 0-117.6 0Z" p-id="6573" data-spm-anchor-id="a313x.7781069.0.i0" class="" fill="#ffffff"></path><path d="M383.1 512m-58.8 0a58.8 58.8 0 1 0 117.6 0 58.8 58.8 0 1 0-117.6 0Z" p-id="6574" data-spm-anchor-id="a313x.7781069.0.i3" class="selected" fill="#ffffff"></path><path d="M125.4 512m-58.8 0a58.8 58.8 0 1 0 117.6 0 58.8 58.8 0 1 0-117.6 0Z" p-id="6575" data-spm-anchor-id="a313x.7781069.0.i4" class="selected" fill="#ffffff"></path></svg>
</div>
</template>
...
<script>
  ...
  data() {
    return {
      ...
      mousedownX: 0,
      mousedownY: 0,
      canDraggable: this.isCanDraggable
    };
  },
  watch:{
    isCanDraggable(){
      this.canDraggable = this.isCanDraggable
    }
  },
  created() {
  ...
  methods: {
    ...
    mouseUp(e) {
      ...
      if (
        ...
        var direction = this.mousedownX <= 60 ? 'left' : 'right'
      var  floatDragDom = this.floatDrag.getBoundingClientRect();
